<!DOCTYPE html>
<!-- saved from url=(0131)http://passport.meituan.com/account/unitivesignup?service=waimai&continue=http%3A%2F%2Fwaimai.meituan.com%3A80%2Faccount%2Fsettoken -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="shortcut icon" href="http://passport.meituan.com/favicon.ico">
    <link rel="icon" href="http://passport.meituan.com/favicon.ico" sizes="16x16 32x32">

    <link rel="alternate" href="http://www.meituan.com/feed" title="订阅更新" type="application/rss+xml">

    <link rel="canonical" href="./注册 _ 美团外卖_files/注册 _ 美团外卖.html">
    <meta name="keywords" content="美团,登录,注册,美团登录,美团注册">

    <title>注册 | 美团外卖</title>

    <link rel="stylesheet" type="text/css" href="/Home/css/bs.css">



    <script type="text/javascript" async="" src="./注册 _ 美团外卖_files/_.gif"></script><script async="" src="./注册 _ 美团外卖_files/saved_resource(1)"></script><script>
...
<body class="pg-unitive-signup theme--waimai">
    ...
    <div class="wrapper cf">
       <h1 class="logo fl">
              <a href="/"  title="美团外卖"><img src="/Home/images/normal-new2.png" alt="美团外卖"></a>
            </h1>
    </div>
</header>
    ...
    <form action="http://passport.meituan.com/account/unitivesignup" method="POST">
            ...
            <div class="form-field form-field--vbtn">
                <label>图片验证码</label>
                    ...
                    <div class="J-captcha captcha-wrapper" style="display:none" hidden="true">
                        ...
                        <img id="signup-captcha-mobile-img" height="34px" width="60px" class="signup-captcha-img J-captcha-refresh" src="./注册 _ 美团外卖_files/captcha">
...
<span id="csrf" style="display:none">M1ZQRssW-Ik5dMdNWHLO6WPh37eSLVZ_f1FQ</span>

<script src="./注册 _ 美团外卖_files/saved_resource(2)"></script>
<script src="./注册 _ 美团外卖_files/saved_resource(3)"></script>
